...
export interface DBNotification {
  id: string;
  user_id: string;
  type: 'score_ready' | 'offer_received' | 'booking_confirmed' | 'interview_scheduled' | 'interview_completed' | 'offer_accepted' | 'offer_declined' | 'system' | 'assessment_assigned' | 'shortlisted' | 'task_due';
  title: string;
  message: string;
  is_read: boolean;
