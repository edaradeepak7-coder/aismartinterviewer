...
const EXPORT_CONFIGS: ExportConfig[] = [
  {
    ...
    fields: ['ID', 'Name', 'Email', 'Role', 'Department', 'Experience Level', 'Status', 'Joined Date'],
    compliance: 'GDPR / Data Audit',
  },
  {
    type: 'transcripts',
    label: 'Interview Transcripts',
    description: 'Interview session records with candidate details, role, type, status, scores, and recommendations.',
    icon: <Mic size={20} />,
    color: 'text-teal-400',
    bg: 'bg-teal-500/10',
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-sm text-white/40">Export platform data for compliance, audits, and external integrations</p>
          </div>
        </div>
      </div>
