...
export default function InterviewerPanel({ voiceState, company }: InterviewerPanelProps) {
  const isActive = voiceState === 'interviewer_speaking' || voiceState === 'listening';
  const companyLabel = company?.trim() || 'AI Interview';
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="text-center">
        ...
        <p className="text-[12px] text-slate-400">{companyLabel}</p>
      </div>
