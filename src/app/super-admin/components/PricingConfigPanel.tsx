...
const DEFAULT_TIERS: PricingTier[] = [
  {
    id: 'starter', name: 'Starter', description: 'AI interview prep for individual candidates. ~$175/mo infrastructure reserve.',
    cost_per_seat: 999, seat_minimum: 1, seat_maximum: 1, billing_period: 'monthly',
  ...
  {
    id: 'professional', name: 'Professional', description: 'Unlimited practice with advanced analytics. ~$350/mo infrastructure reserve.',
    cost_per_seat: 2499, seat_minimum: 1, seat_maximum: null, billing_period: 'monthly',
  ...
  {
    id: 'business', name: 'Business', description: 'Institution-scale hiring & placement platform. ~$600/mo infrastructure reserve.',
    cost_per_seat: 4999, seat_minimum: 10, seat_maximum: null, billing_period: 'monthly',
    is_published: true, is_popular: false, tier_order: 3, badge_label: 'Best Value', cta_label: 'Contact Sales',
