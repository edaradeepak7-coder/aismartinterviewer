...
const allPlans = [
  {
    ...
    features: [
      ...
      '30 Voice Minutes/mo (ElevenLabs)',
      '500 Emails/mo (Brevo)',
      '5 GB Storage',
      '5 Resume ATS Checks',
      '1 Airtable + 1 Calendly',
  ...
  },
  {
    ...
    features: [
      ...
      '300 Voice Minutes/mo (ElevenLabs)',
      '5,000 Emails/mo (Brevo)',
      '25 GB Storage',
      'Unlimited Resume ATS Checks',
      'Multiple Airtable + Calendly',
  ...
  },
  {
    ...
    features: [
      ...
      '1,000+ Voice Minutes/mo (ElevenLabs)',
      '25,000+ Emails/mo (Brevo)',
      '100 GB Storage',
      'Unlimited Resume ATS Checks',
      'Unlimited Airtable + Calendly',
